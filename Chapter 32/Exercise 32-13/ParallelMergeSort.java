...
Exercise 32-13
(Generic parallel merge sort) Revise Listing 32.10 to define a generic parallelMergeSort method as follows:
...
public class ParallelMergeSort {
    ...
    public static <E extends Comparable<E>> void parallelMergeSort(E[] list) {
        RecursiveAction mainTask = new SortTask((Integer[]) list);
