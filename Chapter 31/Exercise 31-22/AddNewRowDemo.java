...
(Use table view) Revise Listing 31.14Links to an external site. to add a button to delete the
...
public class AddNewRowDemo extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Button btDeleteRow = new Button("Delete row"); //Creating the Delete button
        ...
        btDeleteRow.setOnAction(e ->{
            Country line = tableView.getSelectionModel().getSelectedItem();
            tableView.getItems().remove(line);
        });
